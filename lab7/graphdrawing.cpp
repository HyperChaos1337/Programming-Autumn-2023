...
GraphDrawing::GraphDrawing(QWidget *parent)
    : QWidget{parent}{
}

void GraphDrawing::setAdjacencyMatrix(QVector<QVector<qint16>> &adjMatrix){
    this->adjacencyMatrix = adjMatrix;
}

void GraphDrawing::paintEvent(QPaintEvent *event){
    Q_UNUSED(event);
